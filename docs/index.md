...
![toolbar]({{site.baseurl}}/CTT_Toolbar.png)
...
![abstract]({{site.baseurl}}/CTT_GraphicalAbstract.jpg)

## News! CTT Receives Award for Best Desktop GIS Software

![ESRI]({{site.baseurl}}/esri_award.jpg)
...
![etal]({{site.baseurl}}/etal_lab.png)
